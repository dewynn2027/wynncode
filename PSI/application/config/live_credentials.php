...
$config['kount_SERVER_URL'] = "https://risk.kount.net";
$config['kount_REST_ORDER_STATUS_SERVER_URL'] = "https://api.kount.net/rpc/v1/orders/status.xml";
$config['kount_REST_RFCB_SERVER_URL'] = "https://api.kount.net/rpc/v1/orders/rfcb.xml";
$config['kount_REST_VIP_SERVER_URL'] = "https://api.kount.net/rpc/v1/vip/card.xml";
$config['kount_MERC'] 		= 680000;
$config['kount_SCOR'] 		= 33;
$config['kount_KEY'] 		= "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiI2ODAwMDAiLCJhdWQiOiJLb3VudC4wIiwiaWF0IjoxNDI3NDM4MjA5LCJzY3AiOnsia2MiOm51bGwsImFwaSI6dHJ1ZSwicmlzIjp0cnVlfX0.diXNo-UioCnVwuwI0Dp_NOcXC0mwCNYVmxFwGrS4Khg";
...
$config["univips_error"] = array(
	...
	"1001320" => array("The MID (merNo) is not exists", "NA"),
...
$config['firstpayments_payment_init_end_point'] 	= "https://gw2sandbox.tpro.lv:8443/gw2test/gwprocessor2.php?a=init";// https://www2.1stpayments.net/gwprocessor2.php?a=init
$config['firstpayments_payment_charge_end_point'] 	= "https://gw2sandbox.tpro.lv:8443/gw2test/gwprocessor2.php?a=charge";// https://www2.1stpayments.net/gwprocessor2.php?a=charge
$config['firstpayments_refund_end_point'] 	= "https://gw2sandbox.tpro.lv:8443/gw2test/gwprocessor2.php?a=refund";// https://www2.1stpayments.net/gwprocessor2.php?a=refund
$config['firstpayments_status_end_point'] 	= "https://gw2sandbox.tpro.lv:8443/gw2test/gwprocessor2.php?a=status_request";// https://www2.1stpayments.net/gwprocessor2.php?a=status_request
