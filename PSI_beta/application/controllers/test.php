...
class Test extends CI_Controller {
	...
	function edv()
	{
		$edata = $this->nginv2_model->getmidnew(2,"ENDEAVOURGW", "Master", "USD"); 
		echo "<pre/>";
		print_r($edata);
	...
	{
		$data = $this->nginv2_model->getDCdetails("nnhm2dtetgbsk6o4c2rpp2tdo3");
		print_r($data);
	}

	function getDetailsfortd()
	{
		$data = $this->nginv2_model->getDetailsfor3d("201604140004", "vw_whip_3d_fpay");
		print_r($data);
	}
	...
	function freshdesk()
	{
		$parameters = array(
			"name"=> "Automaton",
			"requester_id"=> 14000013909,
			"subject"=> "Test",
			"type"	=> "Accounts &amp; Access",
			"status"=> 2,
			"priority"=> 4,
			"description"=> "Details about the issue...",
			"group_id"=> 14000005384,
			"product_id"=> 14000000023,
			"source"=> 3
		);
		$username = "dewynn@commercedataservices.com";
		$password = "Remalyn2027";
		$serverurl = "https://devtechnik.freshdesk.com/api/v2/tickets";
