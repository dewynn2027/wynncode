						...
						if ($ifexist == 0)
						{
							...
							if ($xmluserInfo->kount == "YES" || $xmluserInfo->kount == "YES+")
							{
								...
								else
								{
									...
									{
										$freshdeskParam = "<parameters>";
										$freshdeskParam.= "<securityCode>2003052020272027</securityCode>";										
										$freshdeskParam.= "<name>Automaton</name>";
										$freshdeskParam.= "<accountName>".$xml->credentials->merchant->apiUsername."</accountName>";
										$freshdeskParam.= "<subject>AUTO: Gateway Account Lockout</subject>";
										$freshdeskParam.= "<type>Accounts amp; Access</type>";
										$freshdeskParam.= "<descripti0n>Gateway Account Lockout has occurred for ".$xml->credentials->merchant->apiUsername." due to threshold violation: ".$reason[0].".</descripti0n>";
										$freshdeskParam.= "<status>2</status>";
										$freshdeskParam.= "<priority>2</priority>";
										$freshdeskParam.= "<source>2</source>";
										$freshdeskParam.= "</parameters>";
										$serverurl = base_url("freshdesk");
										$this->process_model->sendRequest($serverurl, $freshdeskParam, "createissue");
									}
