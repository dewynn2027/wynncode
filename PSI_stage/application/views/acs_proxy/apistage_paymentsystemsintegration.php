...
<textarea name="PaReq" style="width: 390px; height:280px;" placeholder="PaReq"><?php echo $PaReq;?></textarea>
<input type="text" name="MD" value="<?php echo $MD;?>" style="width: 390px;" placeholder="MD">
<input type="hidden" name="TermUrl" value="https://apistage.paymentsystemsintegration.com/test/get3dsecure" placeholder="TermUrl">
<input type="text" name="MerchantTermUrl" value="" style="width: 390px;" placeholder="TermUrl">
<input type="submit" name="send" value="Submit" style="width: 390px;" placeholder="TermURL"><br/>
</form>
